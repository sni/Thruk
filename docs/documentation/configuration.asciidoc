...
Variant 1 - reference a menu from an external file:
...
{% raw %}
  *thruk_local.conf:*
    ...
    <action_menu_items>
        standardmenu      = file:///etc/thruk/action_menus/standardmenu.json
    </action_menu_items>
{% endraw %}
.....


Variant 2 - reference to a pre defined menu:
...
Variant 3 - define the menu in object config only:

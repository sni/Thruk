...
{% include new_since.ad version="2.22" %}
Set interval in seconds to check if cluster nodes are available.
A value of 0 disables the heartbeat. If value is higher than
60 seconds, value is rounded to full minutes.

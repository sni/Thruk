...
-------
  ...
  * thruk_local.d/*     # local override drop dir
...
Local settings drop directory. All files in here override settings from the
thruk.conf file.
...
A menu has the following attributes:
     ...
     ** `icon`          icon for the menu itself. You can use `{% raw %}{{theme}}{% endraw %}` as placeholder in the url
                        and `{% raw %}{{remote_user}}{% endraw %}` for the user name. Within OMD, the the site variable `{{site}}` must be prepended.
...
The menu item can have the following attributes:
     ...
     ** `icon`          icon for the menu item. You can use `{% raw %}{{theme}}{% endraw %}` as placeholder in the url. Within OMD, the the site variable `{{site}}` must be prepended.
     ...
     ** `action`        url or action which will be run or openend. This can either be a
                        ...
                        You may use `{% raw %}{{macros}}{% endraw %}` here too.
...
ex.:
  ...
  <Component Thruk::Plugin::ConfigTool>
    ...
    edit_files                = some/extra/files/to.edit
  </Component>

...
In case chromium is installed on the system already, you can set

  #> export PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true

before running the installer to skip the download. Then add
the system path to ex.: /etc/thruk/thruk.env

...
----
You can also protect your cgi page using the settings from cgi.cfg. 
...
then you can use the function $c->check_user_roles with the appropriate parameters to check the permissions.

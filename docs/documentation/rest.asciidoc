...
|end                               |            |          | unix timestamp of outage end
|host                              |            |          | host name
...
|localtime                         |            |          | current local unix timestamp of thruk host
...
|===========================================
|Attribute                         | Type       | Unit     | Description
|rest_version                      | rest api version |          | rest api version
|thruk_version                     | thruk version |          | thruk version
|thruk_release_date                | thruk release date |          | thruk release date
|localtime                         | current server unix timestamp / epoch |          | current server unix timestamp / epoch
|project_root                      | thruk root folder |          | thruk root folder
|etc_path                          | configuration folder |          | configuration folder
|var_path                          | variable data folder |          | variable data folder
|extra_version                     | might contain omd version |          | might contain omd version
|extra_link                        | contains link from extra_versions product |          | contains link from extra_versions product
|===========================================
...
|compact_duration                  |            |          | duration of last compact run in seconds
|compact_till                      |            |          | timestamp marker where last compact run finished
|data_size                         |            |          | used size of data in bytes
|enabled                           |            |          | flag wether logcache is enabled for this backend or not
|index_size                        |            |          | used size of index in bytes
|items                             |            |          | number of items/rows
|key                               |            |          | peer key
|last_compact                      |            |          | timestamp of last compact run
|last_entry                        |            |          | timestamp of last log entry
|last_reorder                      |            |          | timestamp of last optimize run
|last_update                       |            |          | timestamp of last update run
|mode                              |            |          | current lock mode
|name                              |            |          | peer name
|reorder_duration                  |            |          | duration of last reorder run in seconds
|status                            |            |          | human readable status
|update_duration                   |            |          | duration of last update run in seconds
|===========================================
...
|last_changed                      |            |          | unix timestamp of last change
...
|id                                |            |          | username
|last_login                        |            |          | timestamp of last successfull login

...
list of supported commands:
 ...
 - link:rest_commands.html#post-system-cmd-disable_failure_prediction[disable_failure_prediction]
 ...
 - link:rest_commands.html#post-system-cmd-enable_failure_prediction[enable_failure_prediction]

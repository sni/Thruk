...
sub get_scheduling_queue {
    ...
    my($services) = $self->get_services(filter => [Thruk::Utils::Auth::get_auth_filter($c, 'services'),
                                        ...
                                        columns => [qw/host_name description active_checks_enabled check_options last_check next_check check_interval/],
                                      );
    my($hosts)    = $self->get_hosts(filter => [Thruk::Utils::Auth::get_auth_filter($c, 'hosts'),
                                     ...
                                     columns => [qw/name active_checks_enabled check_options last_check next_check check_interval/],
                                    );

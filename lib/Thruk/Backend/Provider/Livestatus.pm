...
sub get_host_stats {
    ...
    my $stats = [
        ...
        'up_and_disabled'           => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 0, 'active_checks_enabled' => 0 ]}},
        ...
        'down_and_disabled'         => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 1, 'active_checks_enabled' => 0 ]}},
        ...
        'unreachable_and_disabled'  => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 2, 'active_checks_enabled' => 0 ]}},
        ...
        'active_checks_disabled'    => { -isa => { -and => [ 'active_checks_enabled' => 0 ]}},
...
sub get_service_stats {
    ...
    my $stats = [
        ...
        'ok_and_disabled'           => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 0, 'active_checks_enabled' => 0 ]}},
        'ok_and_scheduled'          => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 0, 'scheduled_downtime_depth' => { '>' => 0 } ]}},
        'warning'                   => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 1 ]}},
        'warning_and_disabled'      => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 1, 'active_checks_enabled' => 0 ]}},
        ...
        'critical_and_disabled'     => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 2, 'active_checks_enabled' => 0 ]}},
        ...
        'unknown_and_disabled'      => { -isa => { -and => [ 'has_been_checked' => 1, 'state' => 3, 'active_checks_enabled' => 0 ]}},

...
sub _get_create_statements {
    ...
    # log
        ...
        "CREATE TABLE IF NOT EXISTS `".$prefix."_log` (
          ...
          state_type enum('ACKNOWLEDGEMENT (CRITICAL)','ACKNOWLEDGEMENT (DOWN)','ACKNOWLEDGEMENT (WARNING)','ACKNOWLEDGEMENT (UNKNOWN)','CANCELLED','CRITICAL','CUSTOM (DOWN)','CUSTOM (OK)','CUSTOM (UP)','DISABLED','DOWN','FLAPPINGSTART (CRITICAL)','FLAPPINGSTART (OK)','FLAPPINGSTART (DOWN)','FLAPPINGSTART (UP)','FLAPPINGSTART (WARNING)','FLAPPINGSTART (UNKNOWN)','FLAPPINGSTOP (CRITICAL)','FLAPPINGSTOP (DOWN)','FLAPPINGSTOP (OK)','FLAPPINGSTOP (UP)','FLAPPINGSTOP (WARNING)','FLAPPINGSTOP (UNKNOWN)','HARD','OK','SOFT','STARTED','STOPPED','UNKNOWN','UNREACHABLE','UP','WARNING') DEFAULT NULL,

...
sub close {
    my(undef, $filename) = @_;
    return(_handle_io("close", 1, $filename, \@_));
}
...
sub mkdir {
    ...
    for my $dirname (@dirs) {
        _handle_io("mkdir", 0, $dirname, [$dirname]);
    }
...
sub mkdir_r {
    for my $dirname (@_) {
        _handle_io("mkdir_r", 0, $dirname, [$dirname]);
    }
    return 1;
}
...
sub read {
    my($path) = @_;
    return(_handle_io("read", 0, $path, \@_));
}
...
sub read_decoded {
    my($path) = @_;
    return(_handle_io("read_decoded", 0, $path, \@_));
}
...
sub saferead {
    my($path) = @_;
    return(_handle_io("saferead", 0, $path, \@_));
}
...
sub saferead_decoded {
    my($path) = @_;
    return(_handle_io("saferead_decoded", 0, $path, \@_));
}
...
sub read_as_list {
    my($path) = @_;
    return(_handle_io("read_as_list", 0, $path, \@_));
}
...
sub saferead_as_list {
    my($path) = @_;
    return(_handle_io("saferead_as_list", 0, $path, \@_));
}
...
sub write {
    my($path) = @_;
    return(_handle_io("write", 0, $path, \@_));
}
...
sub file_exists {
    my($path) = @_;
    return(_handle_io("file_exists", 0, $path, \@_));
}
...
sub file_not_empty {
    my($path) = @_;
    return(_handle_io("file_not_empty", 0, $path, \@_));
}
...
sub stat {
    my($path) = @_;
    return(_handle_io("stat", 0, $path, \@_));
}
...
sub rmdir {
    my($path) = @_;
    return(_handle_io("rmdir", 0, $path, \@_));
}
...
sub ensure_permissions {
    ...
    return(_handle_io("ensure_permissions", 1, $path, \@_));
}
...
sub file_rlock {
    my($file) = @_;
    return(_handle_io("file_rlock", 0, $file, \@_));
}
...
sub file_lock {
    my($file) = @_;
    return(_handle_io("file_lock", 0, $file, \@_));
}
...
sub file_unlock {
    my($file) = @_;
    return(_handle_io("file_unlock", 0, $file, \@_));
}
...
sub json_store {
    my($file) = @_;
    return(_handle_io("json_store", 0, $file, \@_));
}
...
sub json_lock_store {
    my($file) = @_;
    return(_handle_io("json_lock_store", 0, $file, \@_));
}
...
sub json_retrieve {
    my($file) = @_;
    return(_handle_io("json_retrieve", 0, $file, \@_));
}
...
sub json_lock_retrieve {
    my($file) = @_;
    return(_handle_io("json_lock_retrieve", 0, $file, \@_));
}
...
sub json_lock_patch {
    my($file) = @_;
    return(_handle_io("json_lock_patch", 0, $file, \@_));
}
...
sub json_patch {
    my($file) = @_;
    return(_handle_io("json_patch", 0, $file, \@_));
}
...
sub touch {
    my($file) = @_;
    return(_handle_io("touch", 0, $file, \@_));
}
...
sub find_files {
    my($dir) = @_;
    my $files = _handle_io("find_files", 0, $dir, \@_);

...
__DATA__
{
    ...
    'service' => {
        ...
        'duplicate_foreach' => 'This directive us used to define a loop using the values of the given macro',
        ...
        'is_volatile' => 'This directive is used to denote whether the service is "volatile".  Services are normally <i>not</i> volatile.  More information on volatile service and how they differ from normal services can be found here.  Value: 0 = service is not volatile, 1 = service is volatile. (Icinga only: 2 = service is volatile but will respect the re-notification interval for notifications)',

...
sub get_cgi_cfg {
    ...
    my $conf = {
        ...
        'authorized_for_broadcasts'                 => ['MULTI_LIST', [], {} ],
        'authorized_for_reports'                    => ['MULTI_LIST', [], {} ],
        'authorized_for_business_processes'         => ['MULTI_LIST', [], {} ],
        ...
        'authorized_contactgroup_for_broadcasts'                => ['MULTI_LIST', [], {} ],
        'authorized_contactgroup_for_reports'                   => ['MULTI_LIST', [], {} ],
        'authorized_contactgroup_for_business_processes'        => ['MULTI_LIST', [], {} ],

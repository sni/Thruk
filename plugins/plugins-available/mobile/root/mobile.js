    ...
    if(info.direction == 'in') {
      jQuery.get('mobile.cgi', {
            ...
            function(data, textStatus, XMLHttpRequest) {
              ...
              // add a more button
              // TODO:
              //jQuery('#notification_list').append('<li class="more"><a href="#more">load 10 more</a></li>');
            },
            'json');
    } else {
      // empty list
...
function refresh_host_status() {
    ...
    jQuery.get('mobile.cgi', { data: 'host_stats' },
        function(data, textStatus, XMLHttpRequest) {
...
function refresh_service_status() {
    ...
    jQuery.get('mobile.cgi', { data: 'service_stats' },
        function(data, textStatus, XMLHttpRequest) {

...
TP.render_host_icons = function(v, td, item, row, col, store, view, data) {
    ...
    if(d.comments.length > 0)          { icons += '<img src="'+url_prefix+'themes/'+theme+'/images/comment.gif" alt="This host has '+d.comments.length+' comments associated with it" border="0" height="20" width="20" class="clickable" onclick="return(host_comments_popup(\''+d.name+'\', \''+item.raw.peer_key+'\'))">'; }
    if(d.scheduled_downtime_depth > 0) { icons += '<img src="'+url_prefix+'themes/'+theme+'/images/downtime.gif" alt="This host is currently in a period of scheduled downtime" border="0" height="20" width="20" class="clickable" onclick="return(host_downtimes_popup(\''+d.name+'\', \''+item.raw.peer_key+'\'))">'; }
...
TP.render_service_icons = function(v, td, item, row, col, store, view, data) {
    ...
    if(d.comments.length > 0)          { icons += '<img src="'+url_prefix+'themes/'+theme+'/images/comment.gif" alt="This service has '+d.comments.length+' comments associated with it" border="0" height="20" width="20" class="clickable" onclick="return(service_comments_popup(\''+d.host_name+'\', \''+d.description+'\', \''+item.raw.peer_key+'\'))">'; }
    if(d.scheduled_downtime_depth > 0) { icons += '<img src="'+url_prefix+'themes/'+theme+'/images/downtime.gif" alt="This service is currently in a period of scheduled downtime" border="0" height="20" width="20" class="clickable" onclick="return(service_downtimes_popup(\''+d.host_name+'\', \''+d.description+'\', \''+item.raw.peer_key+'\'))">'; }

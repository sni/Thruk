...
Ext.define('Ext.ux.BoxReorderer', {
    ...
    afterFirstLayout: function() {
        ...
        // TOD O: Ext5's DD classes should apply config to themselves.
        // TOD O: Ext5's DD classes should not use init internally because it collides with use as a plugin
        // TOD O: Ext5's DD classes should be Observable.
        // TOD O: When all the above are trus, this plugin should extend the DD class.
    ...
    getDragCmp: function(evt) {
        return this.container.getChildByElement(evt.getTarget(this.itemSelector, 10));
    },

    // check if the clicked component is reorderable
    clickValidator: function(evt) {
        var cmp = this.getDragCmp(evt);
    ...
    onDrag: function(evt) {
        ...
        newIndex = me.getNewIndex(evt.getPoint());

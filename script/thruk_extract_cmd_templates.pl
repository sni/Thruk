...
thruk_extract_cmd_templates.pl - extract cmd templates

=head1 SYNOPSIS

./thruk_extract_cmd_templates.pl [ -h ] [ -v ] <file[s]>
...
./thruk_extract_cmd_templates.pl -c <path_to_nagios_cgi_cmd.c> -H <path_to_nagios_include_common.h> templates/cmd_type_*.tt

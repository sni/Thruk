...
_test_filter('host_name = "a" AND host_name = "b"', "Filter: host_name = a\nFilter: host_name = b\nAnd: 2");
_test_filter('host_name = "a" AND host_name = "b" AND host_name = "c"', "Filter: host_name = a\nFilter: host_name = b\nFilter: host_name = c\nAnd: 3");
_test_filter('host_name = "a" OR host_name = "b"', "Filter: host_name = a\nFilter: host_name = b\nOr: 2");
_test_filter('host_name = "a" OR host_name = "b" OR host_name = "c"', "Filter: host_name = a\nFilter: host_name = b\nFilter: host_name = c\nOr: 3");
_test_filter("(name = 'test')", 'Filter: name = test');
_test_filter('(host_name = "a" OR host_name = "b") AND host_name = "c"', "Filter: host_name = a\nFilter: host_name = b\nOr: 2\nFilter: host_name = c\nAnd: 2");
...
_test_filter(' name ~~  "test"  ', 'Filter: name ~~ test');
_test_filter('host_name = "localhost" AND time > 1 AND time < 10', "Filter: host_name = localhost\nFilter: time > 1\nFilter: time < 10\nAnd: 3");
_test_filter('host_name = "localhost" AND (time > 1 AND time < 10)', "Filter: host_name = localhost\nFilter: time > 1\nFilter: time < 10\nAnd: 2\nAnd: 2");
